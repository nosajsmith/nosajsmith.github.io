...
export function resolveBasemapStyle(zoom) {
  ...
  return {
    ...
    paperGrainOpacity: MAP_BASEMAP_TOKENS.paperGrainOpacityByTier[tierId],
    terrainWashOpacity: MAP_BASEMAP_TOKENS.terrainWashOpacityByTier[tierId],
    waterTextureOpacity: MAP_BASEMAP_TOKENS.waterTextureOpacityByTier[tierId],
