...
def _job_summary(case: SuiteCase, batch_result: BatchResult) -> Dict[str, Any]:
    ...
    return {
        ...
        "aggregate": {
            ...
            "success_rate": aggregate.success_rate if aggregate else 0.0,
            "status_counts": dict(aggregate.status_counts or {}) if aggregate else {},
            "result_counts": dict(aggregate.result_counts or {}) if aggregate else {},
            "scenario_outcome_counts": dict(aggregate.scenario_outcome_counts or {}) if aggregate else {},
            "winning_side_counts": dict(aggregate.winning_side_counts or {}) if aggregate else {},
            "core_metrics": dict(aggregate.core_metrics or {}) if aggregate else {},
            "victory_proxy": dict(aggregate.victory_proxy or {}) if aggregate else {},
